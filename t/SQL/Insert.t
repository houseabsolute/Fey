...

{
    ...
    is( $insert->columns_clause($dbh), q{("username")},
...

{
    ...
    is( $insert->insert_clause($dbh), q{INSERT INTO "User"},
        'insert_clause() for User table' );
    is( $insert->columns_clause($dbh), q{("email", "user_id", "size", "username")},
...

{
    ...
    is( $insert->insert_clause($dbh), q{INSERT INTO "User"},
        'insert_clause() for User table' );
    is( $insert->columns_clause($dbh), q{("user_id", "username")},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES ('big')},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES (NULL)},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES (NOW())},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES (term test)},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES (?)},
...

{
    ...
    is( $insert->values_clause($dbh), q{VALUES (1),(2)},
